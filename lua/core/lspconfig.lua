...
function vim.lsp.util.open_floating_preview(contents, syntax, opts, ...)
    opts = opts or {}
    opts.border = opts.border or options.border
    return orig_util_open_floating_preview(contents, syntax, opts, ...)
end

require("lspconfig.ui.windows").default_options.border = options.border
require("lspconfig.ui.windows").default_options.winhighlight = "FloatBorder:FloatBorder"
...
vim.diagnostic.config({
    ...
    float = { source = "always", border = options.border },
